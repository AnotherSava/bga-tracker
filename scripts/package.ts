...
// dist/ (exclude sourcemaps)
addDir("dist", (name) => name.endsWith(".map"));

// assets
addDir("assets/extension");
addFile("assets/bga/innovation/card_info.json");
addDir("assets/bga/innovation/icons");
addDir("assets/bga/innovation/cards");
addDir("assets/bga/azul/tiles");

const outName = `bga-assistant-${version}.zip`;
